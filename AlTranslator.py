...
from tkinter import ttk, Button, X, Text
from tkinter import font, WORD, END
...
class AlTranslator():
    ...
    def __init__(self):
        ...
        inputText = Text(root, font=appHighlightFont, height=11, wrap=WORD,
                         padx=5, pady=5, width=40, fg='#4877bc')
